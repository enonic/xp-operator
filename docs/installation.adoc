...
XP7 clusters require the availability of a shared storage - NFS style. Most cloud providers offer out-of-the-box storage classes for this purpose.
When you created your cluster, you should already have identified or configured this.
