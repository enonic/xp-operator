...
NOTE: We recommend using the latest version of Kubernetes. The minimal version of Kubernetes required by XP Operator is 1.30+.
...
exec java -Doperator.charts.path=helm -Dmicronaut.config.files=/deployments/config/application.properties -javaagent:/opt/agent-bond/agent-bond.jar=jmx_exporter{{9779:/opt/agent-bond/jmx_exporter_config.yml}} -XX:+ExitOnOutOfMemoryError -cp . -jar /deployments/application.jar
 __  __ _                                  _
|  \/  (_) ___ _ __ ___  _ __   __ _ _   _| |_
| |\/| | |/ __| '__/ _ \| '_ \ / _` | | | | __|
| |  | | | (__| | | (_) | | | | (_| | |_| | |_
|_|  |_|_|\___|_|  \___/|_| |_|\__,_|\__,_|\__|
2026-01-02 23:12:24.760 INFO  i.m.c.DefaultApplicationContext$RuntimeConfiguredEnvironment - Established active environments: [k8s, cloud]
2026-01-02 23:12:26.151 INFO  io.micronaut.runtime.Micronaut - Startup completed in 2200ms. Server Running: https://0.0.0.0:8443
2026-01-02 23:12:27,808 INFO  com.eno.kub.ope.Operator - Adding listener 'OperatorIngress'
2026-01-02 23:12:27,889 INFO  com.eno.kub.ope.Operator - Adding listener 'OperatorXpClientCacheInvalidate'
2026-01-02 23:12:27,738 INFO  com.eno.kub.ope.Operator - Adding listener 'OperatorXp8DeploymentHelm'
2026-01-02 23:12:27,799 INFO  com.eno.kub.ope.Operator - Adding listener 'OperatorDeleteAnnotation'
2026-01-02 23:12:27,803 INFO  com.eno.kub.ope.Operator - Adding schedule 'OperatorInformers' [delay: 16337, period: 30000]
2026-01-02 23:12:27,803 INFO  com.eno.kub.ope.Operator - Adding listener 'OperatorXp8ConfigStatus'
2026-01-02 23:12:27,804 INFO  com.eno.kub.ope.Operator - Adding listener 'OperatorIngressLabel'
2026-01-02 23:12:27,806 INFO  com.eno.kub.ope.Operator - Adding listener 'OperatorConfigMapEvent'
2026-01-02 23:12:27,803 INFO  com.eno.kub.ope.Operator - Adding schedule 'OperatorConfigMapSync' [delay: 13252, period: 60000]
2026-01-02 23:12:27,804 INFO  com.eno.kub.ope.Operator - Adding schedule 'OperatorIngressLabel' [delay: 6622, period: 60000]
2024-01-02 23:12:27,806 INFO  com.eno.kub.ope.Operator - Adding listener 'OperatorXp8Config'
2024-01-02 23:12:27,807 INFO  com.eno.kub.ope.Operator - Adding listener 'OperatorIngressCertSync'
2024-01-02 23:12:27,807 INFO  com.eno.kub.ope.Operator - Adding schedule 'OperatorXp8ConfigSync' [delay: 10124, period: 60000]
2024-01-02 23:12:27,808 INFO  com.eno.kub.ope.Operator - Adding listener 'OperatorDomainCertSync'
2024-01-02 23:12:27,809 INFO  com.eno.kub.ope.Operator - Adding listener 'OperatorXp8DeploymentStatus'
2024-01-02 23:12:27,810 INFO  com.eno.kub.ope.Operator - Adding schedule 'OperatorXp8DeploymentStatus' [delay: 4146, period: 60000]
...
The best way of verifying that things are working, is by creating a basic xp8deployment.
The example below will create a namespace, a single-node XP8 server, pre-install selected applications, and configure an ingress.

WARNING: Remember to use a unique namespace per XP deployment. Never use the same namespace as the operator.

=== Prepare namespace

Before creating an Xp8Deployment, the target namespace must have the managed label set to `"true"`. The label key defaults to `enonic.managed` but can be overridden via the `managedLabelKey` value in the operator Helm chart.

A cluster admin must label the namespace manually:
...
Alternatively, include the label when creating the namespace via YAML.

=== Create xp8deployment
...
----
+
. Then run the following command to create the xp8deployment:
+
[source,bash]
----
...
xp8deployment.enonic.cloud/my-deployment created
xp8config.enonic.cloud/my-config created
...
TIP: For details on the operator's security model and how it restricts itself to managed namespaces, see the <<security#, Security>> section.

== Uninstalling the operator

NOTE: Don´t uninstall the xp-operator while there are remaining xp8Deployments on your cluster
