...
WARNING: This software is under development and should not be used for production servers. Read more in the <<op-state>> section.
...
This custom resource manages the configuration of XP nodes.
