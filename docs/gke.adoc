...
If you prefer to run XP only in single mode comment out the shared storage class specification line. The operator can be updated anytime by changing the values.yaml file and running "helm upgrade"
