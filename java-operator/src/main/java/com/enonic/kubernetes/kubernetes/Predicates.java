...
public class Predicates
{
    ...
    public static Predicate<HasMetadata> inSameNamespaceAs( HasMetadata m )
    {
        return inNamespace( m.getMetadata().getNamespace() );
    }

    public static Predicate<Namespace> contains( HasMetadata m )
    {
    ...
    public static Predicate<HasMetadata> isNotDeleted()
    {
