...
import com.enonic.cloud.kubernetes.client.v1alpha1.xp7app.Xp7AppSpec;
...
import com.enonic.cloud.kubernetes.client.v1alpha2.domain.DomainSpec;
import com.enonic.cloud.kubernetes.client.v1alpha2.domain.DomainSpecCertificate;
import com.enonic.cloud.kubernetes.client.v1alpha2.xp7config.Xp7ConfigSpec;
...
import com.enonic.cloud.kubernetes.client.v1alpha2.xp7deployment.Xp7DeploymentSpecNodeGroupDisk;
import com.enonic.cloud.kubernetes.client.v1alpha2.xp7deployment.Xp7DeploymentSpecNodeGroupEnvVar;
import com.enonic.cloud.kubernetes.client.v1alpha2.xp7deployment.Xp7DeploymentSpecNodeGroupResources;
import com.enonic.cloud.kubernetes.client.v1alpha2.xp7deployment.Xp7DeploymentSpecNodesSharedDisk;
