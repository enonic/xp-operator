    ...
    extends CustomResource<S, T>
{
    ...
    public boolean equals( Object other )
    {
        ...
        Crd rhs = ( (Crd) other );
        return Objects.equals( rhs.getApiVersion(), this.getApiVersion() ) && Objects.equals( rhs.getKind(), this.getKind() ) &&
            Objects.equals( rhs.getMetadata(), this.getMetadata() ) && Objects.equals( rhs.getSpec(), this.getSpec() ) &&
