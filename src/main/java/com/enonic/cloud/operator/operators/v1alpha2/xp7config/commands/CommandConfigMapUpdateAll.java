    ...
    implements CombinedCommandBuilder
{
    ...
    protected abstract ResourceInfoXp7DeploymentDependant<V1alpha2Xp7Config, DiffXp7Config> info();
    ...
    private List<ConfigMap> getRelevantConfigMaps( final V1alpha2Xp7Config configResource )
    {
        ...
        return caches().getConfigMapCache().getByNamespace( info().namespace() ).
            filter( filter ).
