package com.enonic.cloud.operator.operators.prepull;
...
import com.enonic.cloud.operator.operators.prepull.commands.ImmutableCommandPrePullImages;
    ...
    extends Operator
{
    ...
    void onStartup( @Observes StartupEvent _ev )
    {
        ...
        {
            runCommands( "NONE", commandBuilder -> ImmutableCommandPrePullImages.builder().
                clients( clients ).
