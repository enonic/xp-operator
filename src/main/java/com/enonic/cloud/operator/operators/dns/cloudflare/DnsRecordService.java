package com.enonic.cloud.operator.operators.dns.cloudflare;
...
import com.enonic.cloud.operator.operators.dns.cloudflare.model.DnsRecordCreateResponse;
import com.enonic.cloud.operator.operators.dns.cloudflare.model.DnsRecordDeleteResponse;
import com.enonic.cloud.operator.operators.dns.cloudflare.model.DnsRecordListResponse;
...
public interface DnsRecordService
{
    ...
    @ClientHeaderParam(name = "Authorization", value = "{com.enonic.cloud.operator.operators.dns.cloudflare.Auth.getApiToken}")
