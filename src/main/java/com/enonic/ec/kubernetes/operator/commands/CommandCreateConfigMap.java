...
public class CommandCreateConfigMap
    implements Command<ConfigMap>
{
    private final Logger log = LoggerFactory.getLogger( CommandCreateConfigMap.class );
    ...
    private CommandCreateConfigMap( final Builder builder )
    {
    ...
    public static final class Builder
    {
        ...
        public CommandCreateConfigMap build()
        {
            return new CommandCreateConfigMap( this );
        }
    }
}
