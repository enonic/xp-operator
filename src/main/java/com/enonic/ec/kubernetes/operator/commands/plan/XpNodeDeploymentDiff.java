...
//            oldDeployment().get().getSpec().nodes().stream().map( SpecNode::alias ).collect( Collectors.toList() );
...
//
//    @Value.Derived
//    public List<SpecNode> nodesRemoved()
//    {
//        if ( oldDeployment().isEmpty() )
//        {
...
//            newDeployment().getSpec().nodes().stream().map( SpecNode::alias ).collect( Collectors.toList() );
//
...
//        for ( SpecNode oldNode : oldDeployment().get().getSpec().nodes() )
//        {
//            Optional<SpecNode> newNode =
//                newDeployment().getSpec().nodes().stream().filter( n -> n.alias().equals( oldNode.alias() ) ).findAny();
//            newNode.ifPresent( SpecNode -> res.add( new NodeTuple( oldNode, SpecNode ) ) );
//        }
//        return res;
//    }
//
...
//    {
//        private final Optional<SpecNode> oldNode;
//
//        private final SpecNode newNode;
//
//        NodeTuple( final SpecNode oldNode, final SpecNode newNode )
//        {
//            this.oldNode = Optional.ofNullable( oldNode );
//            this.newNode = newNode;
//        }
//
//        static NodeTuple of( final SpecNode oldNode, final SpecNode newNode )
//        {
//            return new NodeTuple( oldNode, newNode );
//        }
//
//        Optional<SpecNode> getOldNode()
//        {
//            return oldNode;
//        }
//
