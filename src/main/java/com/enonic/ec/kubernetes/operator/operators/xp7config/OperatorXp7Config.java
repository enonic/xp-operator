package com.enonic.ec.kubernetes.operator.operators.xp7config;
...
import com.enonic.ec.kubernetes.operator.operators.xp7config.commands.ImmutableCommandXpConfigApplyAll;
