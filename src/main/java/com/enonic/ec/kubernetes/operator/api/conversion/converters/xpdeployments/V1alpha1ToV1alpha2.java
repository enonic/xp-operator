...
//import com.enonic.ec.kubernetes.operator.operators.v1alpha2.xp7deployment.crd.Xp7DeploymentResource;
//import com.enonic.ec.kubernetes.operator.operators.v1alpha2.xp7deployment.crd.spec.ImmutableXp7DeploymentSpec;
//import com.enonic.ec.kubernetes.operator.operators.v1alpha2.xp7deployment.crd.spec.ImmutableXp7DeploymentSpecNode;
//import com.enonic.ec.kubernetes.operator.operators.v1alpha2.xp7deployment.crd.spec.ImmutableXp7DeploymentSpecNodeResources;
//
//
//public class V1alpha1ToV1alpha2
//    implements
//    Converter<com.enonic.ec.kubernetes.operator.operators.v1alpha1.xp7deployment.crd.Xp7DeploymentResource, com.enonic.ec.kubernetes.operator.operators.v1alpha2.xp7deployment.crd.Xp7DeploymentResource>
//{
//    @Override
//    public Class<com.enonic.ec.kubernetes.operator.operators.v1alpha1.xp7deployment.crd.Xp7DeploymentResource> consumes()
//    {
//        return com.enonic.ec.kubernetes.operator.operators.v1alpha1.xp7deployment.crd.Xp7DeploymentResource.class;
//    }
//
//    @Override
...
//
//    @Override
//    public com.enonic.ec.kubernetes.operator.operators.v1alpha2.xp7deployment.crd.Xp7DeploymentResource convert(
//        final com.enonic.ec.kubernetes.operator.operators.v1alpha1.xp7deployment.crd.Xp7DeploymentResource source )
//    {
