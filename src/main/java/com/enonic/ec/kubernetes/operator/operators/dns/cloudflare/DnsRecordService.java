...
import com.enonic.ec.kubernetes.operator.operators.dns.cloudflare.model.DnsRecordCreateResponse;
import com.enonic.ec.kubernetes.operator.operators.dns.cloudflare.model.DnsRecordDeleteResponse;
import com.enonic.ec.kubernetes.operator.operators.dns.cloudflare.model.DnsRecordListResponse;
...
public interface DnsRecordService
{
    ...
    @ClientHeaderParam(name = "Authorization", value = "{com.enonic.ec.kubernetes.operator.operators.dns.cloudflare.Auth.getApiToken}")
