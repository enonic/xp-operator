...
import com.enonic.ec.kubernetes.dns.cloudflare.model.DnsRecordCreateResponse;
import com.enonic.ec.kubernetes.dns.cloudflare.model.DnsRecordDeleteResponse;
import com.enonic.ec.kubernetes.dns.cloudflare.model.DnsRecordListResponse;
...
public interface DnsRecords
{
    ...
    @ClientHeaderParam(name = "Authorization", value = "{com.enonic.ec.kubernetes.dns.cloudflare.Auth.getApiToken}")
